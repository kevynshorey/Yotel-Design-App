...
function DesignPageInner() {
  ...
  // Reset auto-generate gate when project switches so new project triggers generation
  useEffect(() => {
  ...
  // Auto-generate on first mount (or after project switch) if no options exist
  useEffect(() => {
